const messages = {
    ko: {
        ...
        HISTORY: {
            ...
            DESC2: `와인바 오프닝 오픈`,
            DATE3: `2022년 4월`,
            DESC3: `오프닝 1<sup>st</sup> Exhibition SPRING PARADOX 개최`,
            DATE4: `2022년 7월`,
            DESC4: `미쉐린 가이드 서울 등재(선발표)`,
            DATE5: `2022년 8월`,
            DESC5: `오프닝 2<sup>nd</sup> Exhibition THE PRESENT 개최`,
        },
        MEMBERSHIP: {
    ...
    en: {
        ...
        HISTORY: {
            ...
            DATE3: `APR. 2022`,
            DESC3: `OPNNG’s 1<sup>st</sup> Exhibition ‘SPRING PARADOX’ held`,
            DATE4: `JUL. 2022 `,
            DESC4: `Michellin Guide Seoul selected and registered (pre-released)`,
            DATE5: `AUG. 2022`,
            DESC5: `OPNNG’s 2<sup>nd</sup> Exhibition ‘THE PRESENT’ held`,
        },
        MEMBERSHIP: {
